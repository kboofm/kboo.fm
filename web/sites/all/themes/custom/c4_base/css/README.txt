...
To use these stylesheets, rename the files and c4_base with the name of your theme.
...
c4_base-alpha-default-narrow.css  
...
c4_base-alpha-default-normal.css
...
c4_base-alpha-default-wide.css
